  ...
  return (
    <div className="min-h-screen flex">
      ...
      <AuthPanel gradient="bg-linear-to-br from-amber-700 to-orange-600">
        ...
        <p className="text-amber-400 text-xs relative">
      ...
      <div className="flex-1 bg-slate-50 flex flex-col overflow-y-auto">
        ...
        <div className="flex-1 flex flex-col justify-center max-w-md mx-auto w-full px-8 py-10">
          ...
          {step === 0 && (
            <>
              <Input
                label="Full Name" placeholder="e.g. Sophia Werner"
              ...
              />
              <Input
                label="Company / Organisation" placeholder="e.g. TechVentures GmbH"
                value={company} onChange={setCompany}
                icon="🏢" error={errors.company} required
              />
              <Select
            ...
            <>
              ...
              <label className="flex items-start gap-3 cursor-pointer mb-4">
                ...
                <span className="text-sm text-slate-600">
                  I agree to the{" "}
                  <span className="text-amber-700 font-semibold">Terms of Service</span>
                  {" "}and{" "}
